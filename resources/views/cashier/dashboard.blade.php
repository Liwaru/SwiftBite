...
<head>
    ...
    <style>
        ...
        .attendance-panel { margin-bottom: 18px; overflow-x: visible; }
        ...
        .attendance-button.check-in { background: var(--cream); color: var(--sidebar-brown-dark); }
                ...
                @if (($mode ?? 'dashboard') === 'dashboard')
                    ...
                    <section class="panel attendance-panel">
                        <div class="attendance-head">
                            <div>
                                <h2>Absensi</h2>
                                <p class="muted">Status absensi hari ini & verifikasi hand gesture 3 jari.</p>
                            </div>
                        </div>
    ...
    <script>
        ...
        function openAbsensiCamera(action) {
            ...
            overlay.addEventListener('click', (event) => {
                if (event.target === overlay) closeAbsensiCamera();
            });
            ...
            async function triggerAbsensiSubmit() {
                ...
                try {
                    ...
                    if (!res.ok) {
                        ...
                        alert('Gagal absensi: ' + text);
                        closeAbsensiCamera();
                        return;
                    }

                    overlay.querySelector('div > div:nth-child(2)').innerHTML = `
