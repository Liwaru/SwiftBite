    ...
    <style>
        ...
        .page-shell { width: 100%; max-width: none; min-width: 0; }
        ...
        .summary-grid { min-width: 0; display: grid; grid-template-columns: repeat(auto-fit, minmax(190px, 1fr)); gap: 14px; margin-bottom: 16px; }
        ...
        .table-card { background: linear-gradient(135deg, var(--brown-light), var(--brown-dark)); color: #fff8ed; border-color: rgba(255, 246, 232, .22); overflow-wrap: anywhere; }
        ...
        .table-wrap { max-width: 100%; overflow-x: auto; border: 1px solid rgba(255, 246, 232, .18); border-radius: 8px; scrollbar-width: thin; -ms-overflow-style: auto; }
        .table-wrap::-webkit-scrollbar { display: block; width: 8px; height: 8px; }
        .table-wrap::-webkit-scrollbar-thumb { background: rgba(255, 246, 232, .34); border-radius: 999px; }
        table { width: 100%; border-collapse: collapse; min-width: min(760px, 100vw); }
        ...
        .menu-rail::-webkit-scrollbar { display: none; width: 0; height: 0; }
        ...
        .panel { max-width: none; min-width: 0; margin-top: 24px; background: #fff6e8; border: 1px solid #e1ad73; border-radius: 8px; padding: 18px; box-shadow: 0 12px 30px rgba(39, 20, 13, .12); overflow-wrap: anywhere; }
        .database-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 14px; margin-top: 16px; }
        .database-card {
            display: flex;
            flex-direction: column;
            gap: 14px;
        ...
        .menu-create-dialog .field-group select,
        .menu-create-dialog .field-group textarea { padding: 10px 12px; }
        ...
        .package-picker-row.is-selected {
            border-color: #9ad28e;
            background: rgba(230, 255, 217, .16);
        }
        .package-picker-row.is-hidden {
            display: none;
        }
        .package-picker-row input[type="checkbox"] {
            width: 18px;
            height: 18px;
            accent-color: #5f8f3d;
        }
        ...
        .package-picker-info strong {
            color: #fff8ed;
            font-size: 13px;
            line-height: 1.25;
            overflow-wrap: anywhere;
        }
        .package-picker-info em {
            color: rgba(255, 248, 237, .68);
            font-size: 12px;
            font-style: normal;
            font-weight: 800;
