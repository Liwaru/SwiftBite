...
<head>
    ...
    <style>
        ...
        .panel { max-width: 780px; margin-top: 24px; background: #fff6e8; border: 1px solid #e1ad73; border-radius: 8px; padding: 18px; box-shadow: 0 12px 30px rgba(39, 20, 13, .12); }
...
<body>
    <div class="app-shell">
        ...
        <div class="content-with-sidebar">
            <main>
                <p class="muted">Area owner</p>
                <h1>Dashboard Owner</h1>
                <section class="panel">
                    <p class="muted">Konten dashboard owner belum diisi.</p>
                </section>
            </main>
        </div>
    </div>
